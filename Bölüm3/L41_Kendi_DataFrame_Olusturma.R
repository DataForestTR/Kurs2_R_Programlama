...
#### DATA FRAME (df) OLUSTUMA ####
Yaslar <- rnorm(20, 40, 10)
Cinsiyetler <- rep(c("Kadin","Erkek","Erkek","Erkek","Kadin"), times = 4)
Egitim_Seviyeleri <- rep(c("Lise","Universite","Yuksek_Lisans","Doktora"), each = 5)
...
dm = cbind(Yas = Yaslar, Cinsiyet = Cinsiyetler, Egitim = Egitim_Seviyeleri)
is.matrix(dm)
df2 = data.frame(dm)
